...
<body>
    <h3 class="mb-4 text-center text-success">Edit Account</h3>
    <form action="#" method="post" enctype="multipart/form-data" >
        <div class="form-outline mb-4">
            <input type="text" value="<?php echo $user_name; ?>" class="m-auto w-50" name="user_username">
        </div>

        <div class="form-outline mb-4">
            <input type="email" value="<?php echo $user_email; ?>" class="m-auto w-50" name="user_email">
        </div>
        ...
        <div class="form-outline mb-4">
            <input type="text" value="<?php echo $user_address; ?>" class="m-auto w-50" name="user_address">
        </div>
        <div class="form-outline mb-4">
            <input type="text" value="<?php echo $user_mobile; ?>" class="m-auto w-50" name="user_mobile">
        </div>
